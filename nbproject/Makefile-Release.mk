...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/poofusion

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/poofusion: ${OBJECTFILES}
...
${OBJECTDIR}/Canal.o: Canal.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Canal.o Canal.cpp

${OBJECTDIR}/ConexionInternet.o: ConexionInternet.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ConexionInternet.o ConexionInternet.cpp
...
${OBJECTDIR}/PaqueteDeCanales.o: PaqueteDeCanales.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PaqueteDeCanales.o PaqueteDeCanales.cpp
...
${OBJECTDIR}/PooFusionExc.o: PooFusionExc.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PooFusionExc.o PooFusionExc.cpp
